...
# Installing PHP 7
RUN apt-get install -y php7.0-fpm php7.0-mbstring php7.0-cli php7.0-mysql php7.0-curl php7.0-gd php7.0-mcrypt php7.0-xdebug php7.0-memcache php7.0-memcached
